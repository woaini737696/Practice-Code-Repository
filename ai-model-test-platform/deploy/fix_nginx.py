...
curl -s -X POST -H "Content-Type: application/json" -d '{"username":"testuser2","password":"testpass123"}' http://localhost/ai-test/api/auth/register
