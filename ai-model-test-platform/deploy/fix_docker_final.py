...
echo ""
echo "=== 检查Docker网络 ==="
docker network ls | grep app-net || echo "app-net网络不存在"
...
curl -s -X POST -H "Content-Type: application/json" -d '{"username":"testuser7","password":"testpass123"}' http://localhost/ai-test/api/auth/register
