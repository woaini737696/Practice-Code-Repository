...
cmd = """#!/bin/bash
echo "=== 测试连接workspace ==="
curl -s -o /dev/null -w "连接115.190.22.21:9999: %{http_code} %{time_total}s\n" http://115.190.22.21:9999/ --connect-timeout 10 2>&1 || echo "无法连接"

echo ""
echo "=== 测试连接workspace其他端口 ==="
curl -s -o /dev/null -w "连接115.190.22.21:9999: %{http_code}\n" http://115.190.22.21:9999/ --connect-timeout 5 2>&1 || echo "无法连接"
